...
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=500 HEIGHT=5 VSPACE=4><BR>
<FONT  COLOR=#F5FAFC></FONT>
<EM><FONT  SIZE=5 COLOR=#000066><STRONG>"Bonsai the BIG" <br>
Prophets &amp; Advisors</STRONG></FONT></EM><BR>
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=500 HEIGHT=5 VSPACE=4></CENTER>
...
<CENTER>
<A NAME="index"></A>
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=80% HEIGHT=5 VSPACE=4><BR>
...
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=80% HEIGHT=5 VSPACE=7><BR>
Click on names for full texts.<BR>
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=80% HEIGHT=5 VSPACE=7></CENTER>

<A NAME="hazel"></A>
<H3>Ecological Economics</H3>
<DL>
<DT><A HREF="../advisors/hazel.html"><H4>Hazel Henderson</H4></A><P><dd> <STRONG>"The real wealth of nations is, of course, their citizens and their educational level and their eco-system resources. But now the world is being run on this strange sort of virtual economy,
...
<A NAME="suzuki"></A>
<DT><A HREF="../advisors/suzuki.html"><H4>David Suzuki</H4></A><dd><STRONG>"Economics is at the heart of the current crisis affecting the planet. And I
...
<DL>
<DT><A HREF="../advisors/wallerst.html"><H4>Immanual Wallerstein</H4></A><DD><STRONG>
...
<CENTER><IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=150 HEIGHT=3 ><BR>
 <A HREF="#index">INDEX</A><BR>
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=150 HEIGHT=3 VSPACE=7 ></CENTER><BR>
<H3>Post-Corporate Democracy &amp; Politics</H3>
<A NAME="nader"></A>
<DL>
<DT><A HREF="../advisors/nadera.html"><H4>Ralph Nader</H4></A><dd><STRONG>"The key focus is
     ...
     right?"</STRONG>
<A NAME="frances"></A>
<DT><A HREF="../advisors/frances.html"><H4>Frances Moore Lappe</H4></A><dd><STRONG>"Instead of just telling people that we're in big
...
<A NAME="chick"></A>
<DL>
<DT><A HREF="../advisors/chick1.html"><H4>Ernest Callenbach</H4></A><dd><STRONG>"The founders could not have foreseen the growth of enormous concentrations of corporate      wealth and power, and the parallel growth of a huge federal establishment ostensibly serving to
...
<CENTER><IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=150 HEIGHT=3 >
...
<A NAME="arne"></A>
<DL>
<DT><A HREF="../advisors/anaes.html"><H4>Arne Naess</H4></A><dd><STRONG>"It's not enough to be
...
<A NAME="banks"></A>
<DL>
<DT><A HREF="../advisors/banks.html"><H4>Dennis Banks</H4></A><dd><STRONG>"(Our Indigenous People's Tribunal would) ask the United Nations to create an Environmental Security Commission.. an international forum 
...
<A NAME="watson"></A>
<DL>
<DT><A HREF="../advisors/watsonly.html"><H4>Lyall Watson</H4></A><DD><STRONG>
...
<A NAME="vanmatre"></A>
<DL>
<DT><A HREF="../advisors/vanmatt.html"><H4>Steve Van Matre</H4></A><dd><STRONG>"I really think that we've
...
<A NAME="weil"></A>
<DL>
<DT><A HREF="../advisors/weil.html"><H4>Andrew Weil</H4></A><dd> <STRONG>"I think the placebo response is really the heart of medicine...  Placebo responses are pure healing responses
...
<A NAME="ry"></A>
<DL>
<DT><A HREF="../advisors/cooder.html"><H4>Ry Cooder</H4></A><DD><STRONG>
...
<A NAME="jerry"></A>
<DL>
<DT><A HREF="../advisors/mander.html"><H4>Jerry Mander</H4></A><DD><STRONG>
