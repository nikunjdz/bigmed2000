...
<BLOCKQUOTE><BLOCKQUOTE><FONT  COLOR=#800000><STRONG>Nancho Advisory: Before "We the People" can ever begin to challenge Big Body rule, we unfortunately have to reawaken to the fact we are fit to rule ourselves. We have been brainwashed to distrust our basic civil competence for so long that it takes a "radical" book like this to remind us what democracy and our revolution were really all about.

</FONT>
 </FONT> </BLOCKQUOTE></BLOCKQUOTE><BR>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=450 HEIGHT=5></CENTER>
<CENTER><H2>A CITIZEN LEGISLATURE
</H2>
<H3><STRONG><U>THE BOLDEST NEW CONSTITUTIONAL <BR>PROPOSAL SINCE THE FEDERALIST PAPERS!</U></STRONG></H3>
<P>
by Ernest Callenbach &amp; Michael Phillips</CENTER><P>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=450 HEIGHT=5></CENTER><P><P>

<TABLE BORDER=3 CELLPADDING=12>
<TR><TD ALIGN=MIDDLE><IMG SRC="${BASE_URL}advisors/graphics/citlegis.jpg" ALT="Citizen Legislature cover" WIDTH=122 HEIGHT=180 BORDER=2><P>
...
<P>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=250 HEIGHT=4></CENTER>


<CENTER><H3>T<FONT SIZE=-1>ABLE OF </FONT>C<FONT SIZE=-1>ONTENTS</FONT></H3></CENTER>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=250 HEIGHT=4></CENTER><P>

<STRONG><FONT  SIZE=3>
<OL>
<LI> The Founders' Ideal: The Legislature as a
 Transcript of the People.                                     

<LI> The Present Electoral System Is Both
 Unrepresentative and Corrupt.                                

<LI> The Democracy of Athens Offers a Better
Model: Selection by Lot.                                     

<LI> Direct Representation Is Scientifically Reliable.           

<LI> A Cross-Section of the People Would Be
  Selected.                                                   

<LI> A Representative House Would Frame Political
  Issues in Unique New Ways.                                  

<LI>The Representative House Would Restore the
 Difference Between the House and Senate.                    

<LI>The Representative House Would Develop Its
 Own Organization.                                        

<LI>The Representative House Would Better Serve
 the General Welfare.                                       

<LI>The Representative House Would Be
  Equivalent to the Nation as a Whole.                       

<LI> The Representative House Would Be at Least
  as Competent as the Present House.                        

<LI> The New House Would Be No More Easily
 Manipulated Than the Present House.                         

<LI> The New House Would Be Less Corruptible      Than the Present House.

<LI> Members of the New House Will Be Representative Even When Absent.

<LI> Campaign Funding Reforms Will Not Solve the Problems of the Electoral System.


<LI> Electronic Technology Cannot Solve the Current Problems of Proper Representation.

<LI> The New House Would Save Taxpayers      Money.

<LI> The New House Would Offer Exciting Benefits      to Chosen Representatives.

<LI>The Representative House Would Encourage      Cooperation Among Members.

<LI> Democratic Representation Would Strengthen      the Republic.

<LI> The Representative House Would Not Disturb      the Balance of Power.

<LI> The Senate Would Remain and Represent  State and Party Interests.

<LI> The Representative House Would Respond More Rapidly to New Problems.

<LI> The Representative House Would Restore a      Sense of Citizenship.

<LI> Practical Implementation Is Possible, Beginning on the State Level.
<LI>     Responses</FONT></STRONG>

</OL><P>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=90% HEIGHT=5></CENTER>
<P><FONT  SIZE=4>
<BLOCKQUOTE><CENTER> <STRONG>CHAPTER I : THE FOUNDERS' IDEAL<BR> THE LEGISLATURE AS A TRANSCRIPT OF THE PEOPLE</STRONG></CENTER>
<P>
...
<P>
The current usual escape from this dilemma is to argue that the representative then must seek to serve national interests -
even if at the cost of a majority of his immediate constituents. What this generally means in practice, 'however, is that unless there is overwhelming popular pressure for some measure, a legislator's acts tend to be influenced primarily by his campaign funding sources; on a wide range of questions our actual non-ideal representatives ignore the known wishes (not to mention interests) of both their constituencies and the rational population, on substantial issues and for substantial periods of time.
<P>
<CENTER><STRONG>CHAPTER II : THE PRESENT ELECTORAL SYSTEM IS <BR>UNREPRESENTATIVE AND PROMOTES CORRUPTION </STRONG></CENTER>
<P>
...
<P>
In such a serious situation, serious remedies deserve consideration. If our representatives as presently chosen are not serving their intended function, citizens must begin thinking about alternative institutions.</BLOCKQUOTE></FONT><P>
<CENTER>- End of Chapter II -</CENTER>
<P>
<P>
<HR WIDTH=300 ALIGN=left SIZE=3>
For the rest of this tightly reasoned revolution, <BR>buy the book, <A HREF="http://www.amazon.com/exec/obidos/ASIN/0960432051/o/qid=932692234/sr=8-1/002-1471198-2256016" target="_blank"><STRONG>A Citizen Legislature</STRONG></A> now!<P>

And click <A HREF="http://www.amazon.com/exec/obidos/Author=Callenbach%2C%20Ernest/002-1471198-2256016" target="_blank"><STRONG>here</STRONG></A> for more of Sri Ernest's seditiously sane suggestions<BR> on everything from Ecology and Ecotopia to Bicycles and Buffalos.
<HR WIDTH=300 ALIGN=left SIZE=3><P><BR>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=300  HEIGHT=5></CENTER>

<CENTER><H4><A href="${BASE_URL}nan2000/2000ally.html">Allies</A> | <A href="${BASE_URL}bigmed2000/advisors.html">Advisors</A> | <A href="${BASE_URL}bigmed2000/nanmain.html">Home</A> | <A href="${BASE_URL}bigmed2000/bigstudy.html">Study</A></H4></CENTER>
<CENTER><IMG SRC="${BASE_URL}bulls/advline2.gif" WIDTH=300 HEIGHT=5></CENTER>
