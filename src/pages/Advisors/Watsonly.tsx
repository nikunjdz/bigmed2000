...
<CAPTION ALIGN=bottom> Lyall Watson</CAPTION>
...
<IMG SRC="${BASE_URL}advisors/graphics/watsonl.jpg" ALT="Lyall Watson"  HSPACE=15 VSPACE=15 BORDER=3  ALT="Sri Lyall"></TD></TR>
</TABLE>
<BR><BR>
...
TO CONSULT HIM THYSELF, SEE HIS WRITING:<BR> <A HREF=http://www.dimensional.com/~randl/watson.htm> LIFE TIDE</A>
<HR WIDTH=90% ALIGN=center SIZE=3>
...
export default AdvisorsWatsonly;
