...
<FONT  COLOR=#FFFFE8><IMG SRC="${BASE_URL}graph/vision5.jpg" ALT="Let us lift our vision..." WIDTH=378 HEIGHT=93 HSPACE=9 VSPACE=9 BORDER=3>
...
<FONT  COLOR=#0000dd> <A HREF="bbonline.html" target="_parent" tabindex="."><BLINK>!</BLINK> Big Body Conference Archive <BLINK>!</BLINK></A><BR>
...
<P>
<FONT  COLOR=#0000dd> Click here to see <BR><A HREF="nhfinal.html">Final NH Results</A><BR>or<BR><A HREF="nhpr2.html">Big Med Press Release</A></FONT></H3>
...
Our initial approach therefore is oblique and memetic. That is, we trust in the power of new <A HREF="../memes/memework.html">memes</A> or contagious ideas to unleash abrupt insights into the true nature of our current dis-ease.
New perceptions can change our understanding and behavior, and thus transform social reality. Once these ideas reach and activate our <A HREF="../sithere.html">eco-social immune system</A> (the random 10% of us who always inexplicably "care"), we should have enough collective force to stop corporate pathology with bio-political craft. 
<P>
...
<P>
Since we have no intention of building a Big Body of our own, you can't really "join" Big Medicine, but you certainly can practise it. Once you understand the principles and share a sense of common purpose, award yourself a doctorate and just go to work. Do check in here regularly, though, for campaign news, progress reports and therapeutic suggestions, and if any of this proves of value to you, please return the favor in <A HREF="aidabet.html">kind</A> or drop some loose change in the <A HREF="support.html">pot</A>.
