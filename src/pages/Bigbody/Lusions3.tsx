...
<H3>< Section III of III ></H3><H3>IDEOLOGY & ANTHROCULTURE <BR> Mind-Binding &amp; Social Conditioning <BR>for Terminal Incorporation</H3></CENTER>
<P>
<FONT SIZE=+1>
<BLOCKQUOTE>
 <P>
...
our main interest.<P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
...
personal relations and group dynamics.<P>
...
cultural structure.<P align=right>

<FONT SIZE=+1><B>Japanese Society</B></FONT><P><P>
<CENTER><STRONG>Mind-Binding: A History</STRONG></CENTER><P>
...
classical expression in Jacob Burckhardt's description of medieval culture:<P>
 <BLOCKQUOTE>In the middle ages, both sides of human consciousness - that which
  ...
  - only through some general category.</BLOCKQUOTE><P>
...
of whom even the court aristocracy had to take heed. <P>
...
common practice among warriors.<P>
...
father and son fought against each other for power.<P>
...
value of on has played an enormously important role in Japan's modernization.<P>
...
period and thus provided the base line for Japan's modern transformation.<P align=right>
<FONT SIZE=+1><B>Japanese Society</B></FONT><P><P>
...
worst of all possibilities.<P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
...
here, in the masochistic and sadistic strivings.<P>
...
what they want, but to submit to the factual or alleged orders of these outside forces.<P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
<CENTER><STRONG>Ecclesiastic Adhesives</STRONG></CENTER><P>
...
individual to identify with him, lose himself within him...<P>
To achieve such selflessness, for the destruction of self, 'ko' (filial piety) is the best 
means:<P>
<BLOCKQUOTE>  "All the errors of mankind arise from 'self' as we think
  'this is my body', 'this is mine', but 'ko' slays self."</BLOCKQUOTE><P>
...
piety in the last analysis meant loyalty for the Japanese:<P>
<BLOCKQUOTE>  "When a father opposes the sovereign, dutiful children desert  their 
  parents and follow the sovereign. This is filial piety at its highest."</BLOCKQUOTE><P>
...
authority, indeed becoming a miniature polity...<P>
...
concrete example from Shinto teachings to illustrate the process:<P>
<BLOCKQUOTE> "Under an Imperial order to build ships, Kawabe-no-Omi,
  ...
  divine Thunderer." </BLOCKQUOTE><P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
...
piety can be fulfilled... <P>
As loyalty and filial piety became almost identified with each other, the training of the 
child in filial piety was so that he might fulfill loyalty as an adult:<P>
 <BLOCKQUOTE> "A samurai who possesses the spirit (filial piety) when he enters service
...
the religious body and the political body.<P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
...
latter remains the central value and religion is subordinated to it (or subsumed in it).<P>
...
the best means to acquire the approval and protection of divine beings.<P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
...
act of freedom is the beginning of reason.<P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
<CENTER><STRONG>Unpayable Debts, Unbreakable Bonds</STRONG></CENTER><P>
...
etc. The significance of this will become clear at a later point.) <P>
...
can never be fully requited:<P>
<BLOCKQUOTE>  "We may carry our mothers on one shoulder, and our fathers on  the other, 
...
Sutra:<P>
<BLOCKQUOTE>  "We are greatly indebted to Sakyamuni. He loved us and taught
  ...
  with precious jewels, yet shall our debt remain unpaid."</BLOCKQUOTE><P>
...
one's bones for countless kalpas.'<P>
...
that in fact the failure of 'blessings' to materialize undermined authority.<P>
...
to the requirements of its authority, feeling its interests to be identical with their own.<P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
<CENTER><STRONG>Collective Response Ability</STRONG></CENTER><P>
...
about when he used the term 'mechanical solidarity'.<P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
...
heredity in its own proper way, is not essentially genetic, but social.'<P align=right>
<FONT SIZE=+1><B>Heredity, Encyclopedia Brittanica</B></FONT><P><P>
...
cultures) where the reverse holds true... <P>
...
to an extent penetrated by it.<P align=right>
<FONT SIZE=+1><B>Tokugawa Religion</B></FONT><P><P>
<CENTER><STRONG>Baby as Part, Baby as Whole</STRONG></CENTER><P>
...
others.<P align=right>
<FONT SIZE=+1><B>"Maternal Care and Behavior
in Japan &amp  America"</B></FONT><P><P>
...
certain level of individuation beyond which the normal individual cannot go.<P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
...
to relieve it by conforming.<P align=right>
<FONT SIZE=+1><B>Japan: An Anthropological Introduction</B></FONT><P><P>
...
cage, it can have everything provided it does not want to leave the cage. <P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
...
that mothers in these cultures interact with these infants rather differently.<P>
...
is somewhat suspect.<P align=right>
<FONT SIZE=+1><B>Japan: An Anthropological Introduction</B></FONT><P><P>
<CENTER><STRONG>Falling into the Greater Whole</STRONG></CENTER><P>
...
kind of ideal person suited to the requirements of large-scale mobilizations. <P>
...
gradual and highly individual progress.<P>
...
concern.<P align=right>
<FONT SIZE=+1><B>"The Promise of Adulthood in Japan"</B></FONT><P><P>
...
which social requirements are transformed into 'personal' qualities.<P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
<CENTER><STRONG>In-Structing for Incorporation</STRONG></CENTER><P>
...
workers on the home front," in the words of historian John  Whitney Hall...<P>
  <BLOCKQUOTE>The Occupation planted the concept of general education in college
  ...
  themselves has already been abandoned..."</BLOCKQUOTE><P>
...
Establishment."<P align=right>
<FONT SIZE=+1><B>Japan Today</B></FONT><P><P>
...
are... <P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
<CENTER><STRONG>Extracting "me", Inserting "We"</STRONG><BR>Out-sourcing the Inner Voice</CENTER><P>
...
pseudo-thoughts are the rule, while indigenous mental acts are the exception....<P>
...
decision is a comparatively rare phenomenon.<P align=right>
<FONT SIZE=+1><B>Escape from Freedom</B></FONT><P><P>
...
which we imagine the life of a cell stands to the life of an organism.<P align=right>
<FONT SIZE=+1><B>Mirror, Sword &amp  Jewel</B></FONT><P><P>
...
free individual must be built.<P>
...
themselves of it... making him bend and bow and vibrate like a tree in wind and rain.<P align=right>
<FONT SIZE=+1><B>Mirror, Sword &amp  Jewel</B></FONT><P><P>
...
consideration.....<P align=right>
<FONT SIZE=+1><B>Japanese Society</B></FONT><P><P>
<CENTER><STRONG>Vicarious Virility</STRONG></CENTER><P>
...
important, provided that the hierarchical structure remains always the same. <P align=right>
<FONT SIZE=+1><B>1984</B></FONT><P><P>
...
Being".<P align=right>
                              					<FONT SIZE=+1><B>Essays on Science and 
Ethics</B></FONT><P>
</BLOCKQUOTE>
<HR WIDTH=80% ALIGN=center SIZE=3><BR>
<CENTER><STRONG>To Be Dragged Out...</STRONG> <BR><FONT SIZE=+1>To be extended, augmented, interpolated, annotated and otherwise enriched. <BR>If you know of any other relevant quotes, passages or sources <BR>that might aid or abet this effort, please suggest or send contributions to:</FONT><BR><BR><A HREF="mailto:bigkarma@nancho.net">BigKarma</A>  </CENTER><P>

<HR WIDTH=80% ALIGN=center SIZE=3><BR><BR>
<HR WIDTH=215 ALIGN=left SIZE=2>
<STRONG>PARTIAL BIBLIOGRAPHY</STRONG>
<HR WIDTH=215 ALIGN=left SIZE=2><BR><BR>
<B>Essays on Science and Ethics,</B>  J.B.S. Haldane, 1932<P>
<B>Japan: An Anthropological Introduction </B>Harumi Befu, Tuttle, Tokyo, '81, 
162 <P>
<B>Japan Today</B>, W.H. Forbis, Tuttle, Tokyo, '75<P>
<B>Japanese Society</B>, Chie Nakane, Univ. of California Press, '86<P>
<B>Mirror, Sword and Jewel</B>, Kurt Singer, Croom Helm, London, '73<P>
<B>Tokugawa Religion</B>, Robert Bellah, Falcon's Wing Press, Glencoe, Ill., '57<P>
...
<BR>
<CENTER><IMG SRC="${BASE_URL}graph/jclulin.gif" WIDTH=400 HEIGHT=5><BR><BR>
<A href="${BASE_URL}bigbody/lusions1.html"><STRONG>Section I</STRONG></A>   |    <A href="${BASE_URL}bigbody/lusions2.html"><STRONG>Section II</STRONG></A>   |   <A href="${BASE_URL}arcmain.html"><STRONG>Main Archive</STRONG></A><BR><BR>
...
export default BigbodyLusions3;
