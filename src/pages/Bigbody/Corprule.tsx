...
const BigbodyCorprule = () => {
  ...
  const html = `<HTML>
<HEAD>
<TITLE>Mander's "Eleven Rules of Corporate Behavior"</TITLE>
</HEAD>
<BODY BACKGROUND="${BASE_URL}barks/slate3.gif" BGCOLOR="#FAF0D6" TEXT="#620000" LINK="#FF4444" VLINK="#00AE00">
<H2>Eleven Inherent Rules of Corporate Behavior<BR> <I>by Jerry Mander</I></H2>

 From <EM>Earth Island Journal</EM>.<BR><BR> <HR><BR>
...
the human beings within it.</I> <P>





1. <B>The Profit Imperative</B>: Profit is the ultimate measure of all
...
2. <B>The Growth Imperative</B>: Corporations live or die by whether
...
Theoretically, privately held corporations -- those owned by individuals
...
3. <B>Competition and Aggression</B>: Corporations place every person
...
Corporate ideology holds that competition improves worker incentive
...
4. <B>Amorality</B>: Not being human, corporations do not have morals
...
5. <B>Hierarchy</B>: Corporate laws require that corporations be structured
...
6. <B>Quantification, Linearity and Segmentation</B>: Corporations require
...
7. <B>Dehumanization</B>: In the great majority of corporations, employees
...
As for management employees, not subject to quite the same indignities,
...
8. <B>Exploitation</B>: All corporate profit is obtained by a simple
...
9. <B>Ephemerality</B>: Corporations exist beyond time and space: they
...
10. <B>Opposition to Nature</B>: Though individuals who work for corporations
...
This transformation of nature occurs in all societies where manufacturing
...
Banks finance the conversion of nature; insurance companies help
...
11. <B>Homogenization</B>: American rhetoric claims that commodity society
...
Native societies -- which celebrate an utterly non-material relationship
...
In the undeveloped parts of the world, where corporations are
...
good way; national culture is inferior.&quot;
...
<P><CENTER>{ { Order online from <A HREF="http://www.amazon.com/">Amazon.com</A> } }</CENTER><P>

<EM>HTML page courtesy of </EM><A HREF="http://www.igc.apc.org/">Earth Island Journal </A>,  <I>Winter 94, Vol. 10 Issue 1, p30+ <HR>
<CENTER>Copyright 1995, Earth Island Journal. <BR>Articles may be freely reprinted with prior permission. <BR>Please credit </I><B>Earth Island Journal</B><I> and send samples.</I></CENTER>
<HR WIDTH=95% ALIGN=center SIZE=3>
<P>
<HR WIDTH=100 ALIGN=center SIZE=3>
<CENTER>
<A href="${BASE_URL}arcmain.html#bbpathology">Back to<BR><STRONG>Big Bodies</STRONG></A></CENTER>
<HR WIDTH=100 ALIGN=center SIZE=3>
</HEAD>
</HTML>
`;
...
export default BigbodyCorprule;
