...
<H3>"Illuminating Atrocities"</H3> 
<H4>Disturbing the Purchased Peace with Nobel Laureate Jose Ramos Horta</H4>
<H5>Interviewed by W. David Kubiak<BR>Japan Civil Liberties Union, Kyoto</H5>
<HR WIDTH=300 ALIGN=CENTER SIZE=3><BR>
</CENTER>
<BLOCKQUOTE>More than 20 years and 200,000 starved, slashed and bullet-riddled
corpses later, the world slowly awakens to the ongoing tragedy of East
Timor. Confiscated to famine by its Japanese invaders and randomly
brutalized for Western sympathies during the Pacific war, this
isolated Portuguese colony buried fully a tenth of its population in
the years from 1943-45. Thirty years later in 1975 as Portugal was
finally withdrawing and the natives boisterously prepared for
independence, violent disaster struck again as Indonesia invaded and
brutally "annexed" the island. This time, however, the East Timorese
fought back. Their fierce defensive war against the onslaughts of the
Indonesian army lasted nearly four years before it was crushed with
modern fighter jets and other high tech weaponry illegally supplied by
the U.S. and British governments. Between the battle toll and
subsequent massacres and starvation, the local Catholic Church
estimates that Indonesia has killed at least a third of the
pre-invasion populace. Although the struggle of resistance continues
to this day and the per capita victimization ranks second only to the
Holocaust for genocidal savagery, the international community and the
mass media in particular have remained abjectly silent for decades.
With the active complicity of Japan and most Western powers, Indonesia
has also adroitly stifled United Nations action on all Portugal's
appeals to grant its ex-colony the right of self-determination as
clearly guaranteed by the UN charter and international law. What a
distressing surprise for Indonesia's apologists and spin doctors then
when the enigmatic octogenarians of Norway's Nobel Committee awarded
the Peace Prize and global podium last year to East Timor's Cardinal
Belo and Jose Ramos Horta. While Cardinal Belo morally appeals for his
people�s rights in a style reminiscent of the Dalai Lama, Ramos Horta
rages for justice with the passion and vehemence of an Old Testament
prophet. In an increasingly ruthless new world order where human
rights are routinely subordinated to economic advantage, this angry
laureate has committed his life to disrupting the conspiracy of
silence shrouding tyrannic terror both in East Timor and across the
breadth of Asia.</BLOCKQUOTE>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  Who have been your major supporters over the years?
<P>
JRH:  NGOs.
<P>
<FONT  SIZE=-1>WDK</FONT>:  For example.
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>: Your official title during all this activity is Special Representative of the National Council of Moubere Resistance. What does this Council actually do?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  As the special representative, you work in their name when you speak overseas?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  This is a network that could function as a shadow government or does function as a shadow government?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  That line is still alive today, of course, and bringing us up to the present day, you haven't exactly had a warm welcome in Tokyo. Leaders here obviously seem more concerned about the foreign cars coming into Indonesia in competition with theirs than it does about the plight of any of the occupied peoples. Did you anticipate this kind of rebuff from the government and how do you see it playing out in the future?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  About this spotlight of opportunity you are granted now -- the Nobel Prize is a very bright light but it tends to grow dimmer as the years progress. How do you plan to exploit this and what is your best case scenario for use of this time?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  In the immediate neighborhood there seems a possibility for some sort of network...for example, with the people fighting for independence in West Papua, or against the occupation that is occurring in Acche, not to mention Burma or Tibet -- are you developing any linkages with these movements?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>: Regarding the movement in Indonesia itself, there have been stirrings of democracy within the last year that have provoked rather brutal and naked censorship and sabotage of citizen-based movements and media there. How do you see that playing out over the next five years?
<P>
JRH:  Well, I hope that the democracy movement does not lose courage, vision, strength; that it goes from strength to strength.
<P>
<FONT  SIZE=-1>WDK</FONT>:  How would you assess its current grassroots support though?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  But they've ignored the Security Council before. What is the power of Indonesia? Why are so many countries afraid to cross it?
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  But specifically, what is their power? The Cold War domino theory has pretty much gone down, there's no communist threat down there that anybody believes in, the economy is significant but not overwhelming like China, and yet they command the same kind of timidity.
<P>
...
<P>
<FONT  SIZE=-1>WDK</FONT>:  What do you want people to do now? I mean, people learn about this, they're suitably horrified, so what is the next step?
<P>
...
<H4>
Originally published in Kyoto Journal, Spring '97</H4>
<HR WIDTH=300 ALIGN=left SIZE=2>
</TD></TR>
</TABLE>
<P>
