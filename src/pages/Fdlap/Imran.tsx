...
<H3>"Islam means Justice, <BR>and Justice means Rights"</H3> 
<h4><FONT  COLOR=#002400>An Interview with Imran Khan<BR></FONT></h4>
<HR WIDTH=300 ALIGN=CENTER SIZE=3><BR></TD><TD ALIGN=MIDDLE><IMG SRC="${BASE_URL}fdlap/graph/imran5.jpg" ALT="Imran Khan" WIDTH=141 HEIGHT=200 HSPACE=20 BORDER=1 ></TD></TR>
</TABLE>
</CENTER>
<TABLE>
...
<P>
So, therefore the idea was to bring these issues to the public, expose these people to the public, knowing that we would lose the elections. So, that was the number one reason we fought the election. And the second reason was that we could use the election to help us form a party infrastructure, a process which usually takes years. Using the election campaign, we now have a structure that we have been consolidating ever since. The people with us now are real revolutionaries. One of the good things about losing elections is that you get rid of all the opportunists, and only the committed, ideological people remain. </BLOCKQUOTE>

<h4><FONT  COLOR=#002400>Nancho: Having come yourself from a rather privileged class here in Pakistan, what credentials do you feel you have for leading the poor, the impoverished, the disenfranchised?</FONT></h4>

<BLOCKQUOTE>IK: The assumption that only an underprivileged person can understand how the underprivileged feel is not really true. Nawaz Sharif's family, for example, if you go back just one or two generations, were very underprivileged. It did not mean that once he came into power, he started looking after the underprivileged. No, he started looking after himself. Similarly, there are people who have been very privileged, but God creates compassion in them for the poor. So, the two are not necessarily connected. I have to confess that I never thought of the poor people. I was not born with compassion for poor people. <P>
