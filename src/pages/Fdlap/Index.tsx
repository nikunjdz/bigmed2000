...
<TR><TD BGCOLOR="#003E1F"><IMG SRC="${BASE_URL}bulls/flame2.gif" WIDTH=30 HEIGHT=60></TD><TD ALIGN=CENTER BGCOLOR="#000000"><FONT SIZE=+2 COLOR=#9999FF><STRONG>THE FORUM OF DEMOCRATIC LEADERS IN THE ASIA-PACIFIC</STRONG></FONT></TD><TD BGCOLOR="#003E1F"><IMG SRC="${BASE_URL}bulls/flame2.gif" WIDTH=30 HEIGHT=60></TD></TR>
</TABLE>
...
<hr width="300" size="4">
<strong>- <font color="#FF0000" size="5"><blink>!</blink></font> - <a href="${BASE_URL}fdlap/fdlalert.html">FDLAP ALERTS</a> - <font color="#FF0000" size="5"><blink>!</blink></font> -<br>
The Crisis in Kashmir</strong>
<hr width="300" size="4">
<p>
...
<IMG SRC="${BASE_URL}fdlap/graph/fdline5.gif" WIDTH=100% HEIGHT=6 VSPACE=9><BR>
<P><SMALL>Visitors since 14 July 98:</SMALL><BR><IMG SRC="${BASE_URL}counter/org/bigkarma/fdlap/fdlap.cnt" ALT="counter" WIDTH="80" HEIGHT="20"></P> 
</CENTER>
`;
