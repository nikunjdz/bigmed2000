...
<BR><BR>
<CENTER>
<IMG SRC="${BASE_URL}bulls/brnblk.gif" WIDTH=550 HEIGHT=8>
<H2>THE ABHORRENCE OF EXOTIC IDEAS</H2>
<H3>Japan's Comparative Advantage in Memetic Immunity</H3>
<HR WIDTH=175 ALIGN=center SIZE=2>
<FONT  SIZE=-1><EM>by W. David Kubiak</EM><br>
<a href="http://www.kyotojournal.org/kjback/kjback22-24.html#24" target="_blank">Kyoto Journal #24, 1993</a></FONT>
<HR WIDTH=175 ALIGN=center SIZE=2>
<IMG SRC="${BASE_URL}bulls/brnblk.gif" WIDTH=550 HEIGHT=8>
<BR><BR>
</CENTER>
...
<BLOCKQUOTE>
<FONT  SIZE=3>
<STRONG>In the real old days,</STRONG> before it became such a technical, tumorous business, pollution was a far more spiritual affair. The ancients knew not isotopes, CFCs or pesticidal residues, but well they understood the nasty contaminants the soul was heir to.<P>

The hierarch's historical ideal was always <EM>mens sana in corpore sano</EM> - healthy bodies for toil, and minds cleansed of skepticism and strange ideas. Whatever corrupted people's hearts, weakening their docile support of the status quo, polluted the tranquil purity of the culture. Heterodox notions like justice, equality, evolution, et seditious cetera provoked corrosive questioning of the omniscience, wisdom and privileges of the power-that-be.<P>

Such malignant cultural contaminants could be contracted many places - from books, intercourse with aliens, wild dreams, but most of all from travel. Travel positively drenched you with danger, exposing the undisciplined mind to heretical takes on "common sense," "normal behavior," even the nature of "human being."<P>

In the East, therefore, many ancient Hindu, Buddhist and Islamic cultures quarantined returning citizens until acquired contagion's were diagnosed, shriven and ritually recanted. In medieval Japan, greeting committees for unauthorized rovers tended to favor precautionary beheading as a more poignant and cost-effective cure. <P>
Suffice to say, containment and eradication of psychic pollutants became a lively professional specialty in many archaic hierarchies. 
Whether burning witches, blacklisting Hollywood directors or gulaging counter-revolutionaries, establishment immune systems recognized the threat of the internalized "other" and moved against it with dispatch.<P>

Study of the spread of such social diseases, and cultural diffusion in general, has recently been codified into a new science called memetics. Memetics studies memes, which have variously been described as:<P>

<UL TYPE=disc>

<LI>a) transmittable patterns of cultural information;
<LI>b) "cultural genes" and/or "cultural viruses."
<LI>c) replicable information "molecules" that tell us <U>how to</U> think about, value or do something.

</UL>


Virtually every aspect of culture we learn from or teach to others is a meme, Memes can be simple, telling us how to write haiku, play poker or respect elders. Or they can be complex and tell us how to practice Buddhism, quantum physics or democracy. Memes are thus the basic unit of cultural transmission, education and heritage.<P>

<CENTER><TABLE BORDER=4 CELLPADDING=5 HSPACE="25" ALIGN=LEFT >
<CAPTION ALIGN=bottom>Buddhist Meme in Migration</CAPTION>
<TR><TD ALIGN=MIDDLE><IMG SRC="${BASE_URL}graph/birdmem2.gif" BORDER=3 ALT="Buddhist Meme Winging West" WIDTH=200 HEIGHT=199 ></TD></TR>
</TABLE></CENTER>
...
Yes, just like apes, bees, chickens and <EM>sararimen</EM>, genes organize themselves into hierarchies. And the "conductor genes" at the top tell the other genes what to do, when to do it and when to stop. Mostly they tell them how and when to create the molecular enforcers (enzymes, hormones, nucleotides, etc.) that keep the neighborhood in working order.<P>

  <CENTER><H3><U>A META-MEME IS A JEALOUS MEME</U></H3></CENTER>

The same is true in the meme communities of our minds. Some memes are more equal than others, and these "conductor memes" are called "meta-memes."  Meta-memes are usually ideologies, religions, philosophies or some kind of "ism" that defines all of reality and are empowered by deep belief. Historically, most meta-memes were sovereign in their cultures because the society's members just didn't know any better. They were never polluted with alternatives.<P>

But even when we learn of memes for many religions and ideologies, it is faith that elevates one among them to meta-meme status. The selection process may often seem accidental or arbitrary, but once  enthroned, meta-memes are tyrannical. They will not, or more accurately, cannot share their control functions with competitors.<P>

Take classic meta-memes like Maoism, Islam or <EM>kaisha-shugi</EM> (Japanese "corporation-ism"). Each arrogates primary authority over all their members' attitudes and life activities. Each, therefore, claims the right to decide what other memes are welcome in the psycho-social community. The Islamic meta-meme, for example, frowns balefully upon the free circulation of memes that tell you how to bake ham, brew sake or crack Salman Rushdie jokes.<P>
<CENTER>
<TABLE BORDER=5 CELLPADDING=5>
<CAPTION ALIGN=bottom>Big Daddy keeping the lads in line...</CAPTION>
<TR><TD ALIGN=MIDDLE><IMG SRC="${BASE_URL}graph/mosechu-.jpg" ALT="Hierarchy at Work" WIDTH=331 HEIGHT=450 BORDER=2></TD></TR>
</TABLE>
<BR>


<H3><U>AUTHORITARIANISM: MEMES AGAINST MATURITY</U></H3></CENTER>

The more authoritarian the meta-meme, the longer its list of no-nos. While different "isms" reject different memes (communism forbids private property, fundamentalism outlaws evolution, Nazism dismisses human equality, etc.), all authoritarian meta-memes tend to oppose the psychic maturation of their members.<P>

From an authoritarian point of view, maturation is destabilizing. Unchecked it leads the population to adulthood, individuation and seminal thinking, all of which encourage those offensive mutations that threaten schism, revolution or the supplanting of authority. Since elites must preserve at all costs the memes that assign them power, they are all status quo conservative. (This simple insight clears up a lot of the semantic confusion we encounter finding the same so-called "conservative" defending radically different memes in Japan, Russia, Iran, etc.)<P>

Authoritarian meta-memes generally instruct us to accept a specific "ism," and submit our lives to its representatives who rule society as a patriarchal house-hold. Pope John Paul, Lee Kuan Yew, Kim Il Sung and Ayatollah Khomeini all represent very different meta-memes, but the paramount value in each of their societies is the same: total, child-like obedience. Children almost by definition are not interested in the crafts or responsibilities of civil politics. They are immature beings without real rights who must be protected, taught and disciplined. Politics and power are the business of elders - officials, Fathers, <EM>oyabun</EM>, et al. Authoritarians therefore train citizens for endless childhood, i.e., life-long dependence, conformity and obedience. "Don't you bother your little heads..."<P>

[Of note here is MacArthur's famous quote that he found "Japan a nation of 12-year-olds" in '45 (and was generally content to leave it that way in '52). Of further interest is the fate of Japan's crowded ranks of <EM>kobun</EM> and all women here whose names end in <EM>ko</EM>, since "ko" ("<IMG SRC="${BASE_URL}graph/ko12.gif" WIDTH=32 HEIGHT=25 ALIGN=absmiddle>" : the ideogram for "child") explicitly implies such people may be treated as children throughout life.]<P>

<CENTER><H3><U>GROWING UP DEMOCRATIC</U></H3></CENTER>

Democratic meta-memes, by contrast, positively demand that citizens grow up. The practice of democracy requires effort and adulthood from everyone, and therefore necessitates individuality, responsibility and creative evolution. (It is thus no accident that most of modern history's great inventions, cultural innovations, and Nobel prize-winners have issued from democratic societies.)<P>

The trouble with democracy is its gross "inefficiency." Citizen participation in decision-making takes time, decentralizes power and exposes real conflicts over priorities. Should consumerism or conservation govern our economics? Should corporate expansion outrank the environment? The conflicts at issue are legion and important: high growth vs. zero growth; agribusiness vs. family farming; trade blocks vs. bioregions; nuclear power vs. renewable sources; state's rights vs. human rights; et significant cetera. In democracies the clash of values and agendas is a lengthy, noisy affair. But when choices are finally made by flesh-and-blood people, as opposed to corporate bodies, they tend to reflect basic human values that resonate with environmental and humanitarian concerns.<P>
...
<A href="${BASE_URL}memes/memework.html">Memework</A> | <A href="${BASE_URL}arcmain.html#memes">Main Archive</A> 
<HR WIDTH=150 ALIGN=center SIZE=3>
<IMG SRC="${BASE_URL}bulls/brnblk.gif" WIDTH=330 HEIGHT=6>
<H5><A href="${BASE_URL}sharight.html">Shareright</A> (S) 1998 : Big Medicine 
</H5>
