...
<H2> Nancho Consults: Dr. Frederick vom Saal </H2>
<H3>Hormone Specialist from the University of Missouri</H3>
<IMG SRC="${BASE_URL}bulls/brnblk.gif" WIDTH=450 HEIGHT=7 VSPACE=2></CENTER>
<P>
<BLOCKQUOTE><FONT  COLOR=#BF0000><STRONG>Nancho Advisory:</STRONG> </font>



<H4><font color="#400000">Nancho: How did you get involved with the authors of Our <A HREF="http://www.amazon.com/exec/obidos/ASIN/0452274141/002-7792184-8613222" target="_blank">Stolen Future</A> and the endocrine disrupter issue?</font></H4><br>

<blockquote><strong>Vom Saal:</strong> It started by talking to Theo Colburn about an idea that was just forming in her mind at the time. She noticed the work that I was doing on very low doses of hormones and how they alter development, and thought if that was possible then low doses of environmental chemicals could also have an effect. She said she wanted to have a meeting to discuss this, and that was the Wingspread meeting and we have been working on this issue ever since. 
<P>
...
<P>
Somebody asked me recently, 'How could you expect Dow Chemical or General Electric or Exxon, that between them probably make more than five billion dollars a year on bisphenol A, how could they possibly design and conduct a study that they really expect to show that this chemical is dangerous, and that they should not make this five billion dollars of profit? Do you think that is likely?'</blockquote>

<H4><font color="#400000"> Given those facts, though, and the scale of the economic problem and the threat to corporate structures and profit flows, the opposition will be staggering. And you are just depending on individual university laboratories and academic freedom to generate enough truth to fend them off?</font></H4><br>

<blockquote><strong>VS:</strong> This is an extremely serious problem. At the moment the answer to your question is yes, because there is very little money available to do this type of work. One of the problems is that there are people in the government hierarchies everywhere who are resistant to allowing their agencies to really focus on this problem. 
<P>
...
export default AnthcultVomsaal;
