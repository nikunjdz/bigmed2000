...
<H3>"CASTRATION"<BR> THE MAJOR GOAL
         OF JAPANESE EDUCATION, AND<BR>
      ITS RELATIONSHIP TO GOVERNMENT DEREGULATION</H3>
<H4>By  Masao Miyamoto M.D.</H4>
<H5>PAPER PRESENTED AT<BR>
UNIVERSITY OF OXFORD and UNIVERSITY OF CAMBRIDGE<BR>
         OCTOBER 20TH AND 23RD, 1995<BR>
        OXFORD AND CAMBRIDGE, ENGLAND</H5>
...
<A href="${BASE_URL}anthcult/castrhiv.html">Miyamoto on Castration/HIV Scandal</A>  |  
...
export default AnthcultCastreg;
