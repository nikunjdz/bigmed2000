...
<CENTER><IMG SRC="${BASE_URL}bigmed2001/graph/jclulin.gif" WIDTH=400 HEIGHT=6 VSPACE=6><BR>
<FONT  SIZE=4><B>BIG BODY BOOK WORK<BR>- Learning to Diagnose Corporate <BR>Maladies in Your Body Politic</B></FONT>
<BR><IMG SRC="${BASE_URL}bigmed2001/graph/jclulin.gif" WIDTH=400 HEIGHT=6 VSPACE=7></CENTER>
...
<CENTER><IMG SRC="${BASE_URL}bigmed2001/graph/jclulin.gif" WIDTH=90% HEIGHT=6 VSPACE=7></CENTER>
...
<CENTER><IMG SRC="${BASE_URL}bigmed2001/graph/jclulin.gif" WIDTH=80% HEIGHT=4></CENTER>
...
<LI><A href="${BASE_URL}bigmed2001/bigread2.html##lsystems">L<FONT SIZE=-1>IVING SYSTEMS</A> -  by James Grier Miller </FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#crowd">T<FONT SIZE=-1>HE CROWD</A> - by Gustave Le Bon</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#groupmind">T<FONT SIZE=-1>HE GROUP MIND</A> - by William McDougall</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#japan">J<FONT SIZE=-1>APANESE SOCIETY</A> - by Chie Nakane</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#beelife">L<FONT SIZE=-1>IFE OF THE BEE</A> - by Maurice Maeterlink</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#industrial">T<FONT SIZE=-1>HE NEW INDUSTRIAL STATE</A> - by J.K. Galbraith</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#escape">E<FONT SIZE=-1>SCAPE FROM FREEDOM</A> - by Erich Fromm</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#obey">O<FONT SIZE=-1>BEDIENCE TO AUTHORITY</A> - by Stanley Milgram</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#kampf">M<FONT SIZE=-1>EIN KAMPF</A> - by Adolf Hitler</FONT>
<BR><BR>
<A NAME="anthcult"></A>
...
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#castrate">
A<FONT SIZE=-1> BRIEF HISTORY OF CASTRATION</A> -              by Victor T. Cheney</FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#castrate">C<FONT SIZE=-1>HINESE EUNUCHS</FONT></A>                  -  by Taisuke Mitamura </FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#fearstress">T<FONT SIZE=-1>HE PSYCHOLOGY OF FEAR AND STRESS</A>  -  by Jeffrey Alan Gray </FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#farm"> B<FONT SIZE=-1>EHAVIOURAL PROBLEMS OF FARM ANIMALS</A> -   by M. Kiley-Worthington </FONT><BR> 
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#organman">T<FONT SIZE=-1>HE ORGANIZATION MAN</A>     - by William Hollingsworth Whyte</FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#eunuch">T<FONT SIZE=-1>HE CORPORATE EUNUCH</A> - by O. William. Battalia </FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#femimale">T<FONT SIZE=-1>HE FEMINIZED MALE: CLASSROOMS, WHITE COLLARS, <BR>AND THE DECLINE OF  MANLINESS</A> - by Patricia Cayo Sexton</FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#crisis">T<FONT SIZE=-1>HE MALE IN CRISIS</A>         -  by Karl Bednarik</FONT>
</UL>
</FONT>
<CENTER><IMG SRC="${BASE_URL}bigmed2001/graph/jclulin.gif" WIDTH=80% HEIGHT=4></CENTER>
...
<UL>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#humanscale">H<FONT SIZE=-1>UMAN SCALE</A> - by Kirkpatrick Sale</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#postcorp">T<FONT SIZE=-1>HE POST-CORPORATE WORLD : <BR>LIFE AFTER CAPITALISM</A> - by David Korten</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#reclaiming">G<FONT SIZE=-1>LOBALIZING CIVIL SOCIETY : RECLAIMING OUR RIGHT TO POWER</A> - by David Korten</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#turnlocal">T</FONT><FONT SIZE=-1>HE CASE AGAINST THE GLOBAL ECONOMY ,<BR>
AND FOR A TURN TOWARD THE LOCAL</A> by Mander &amp; Goldsmith (Editors)</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#phenomenon">T<FONT SIZE=-1>HE PHENOMENON OF MAN</A> - by Pierre Teilhard de Chardin</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#power10">P<FONT SIZE=-1>OWERS OF TEN</A> - by Philip &amp; Phylis Morrison</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#earthdream">T<FONT SIZE=-1>HE DREAM OF THE EARTH</A> - by Thomas Berry</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread2.html#dragon">T<FONT SIZE=-1>HE UNIVERSE IS A GREEN DRAGON : <BR>A COSMIC CREATION STORY</A> - by Brian Swimme</FONT>

</UL></BLOCKQUOTE>

<CENTER><IMG SRC="${BASE_URL}bigmed2001/graph/jclulin.gif" WIDTH=90% HEIGHT=6></CENTER>
...
--<A href="${BASE_URL}bigmed2001/gospels/ivinstax.html">Molly Ivins</A>, author of Molly Ivins Can't Say That, Can She? &quot;
<P>
When
...
mold physiology (e.g., <A href="${BASE_URL}bigmed2001/bigbody/lusions1.html">Lusions</A>), you
...
export default Bigmed2001Bigread1;
