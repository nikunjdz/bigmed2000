...
<BR>
<IMG SRC="${BASE_URL}bigmed2001/graph/advline2.gif" WIDTH=50% HEIGHT=3 vspace=5><BR>
...
<P>
<IMG SRC="${BASE_URL}bigmed2001/graph/advline2.gif" WIDTH=50% HEIGHT=2 vspace=5><BR>
...
export default Bigmed2001Bigfaq;
