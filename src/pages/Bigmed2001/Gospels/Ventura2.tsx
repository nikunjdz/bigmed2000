...
const Bigmed2001GospelsVentura2 = () => {
...
<H4>Back to: <A href="${BASE_URL}bigmed2001/gospels/ventura.html">Part 1: Primer on Revolution</A></H4>
<H4>Next to: <A href="${BASE_URL}bigmed2001/gospels/ventura3.html">Part 3: How To Get There</A></H4><P>
<I>(Reprinted in the <A HREF="http://www.wwfreepress.com/">World Wide Free Press</A> from the Austin <BR>Chronicle by permission of Michael Ventura).</I><P><CENTER><IMG SRC="${BASE_URL}bigmed2001/graph/advline2.gif" WIDTH=300 HEIGHT=5></CENTER>
...
export default Bigmed2001GospelsVentura2;
