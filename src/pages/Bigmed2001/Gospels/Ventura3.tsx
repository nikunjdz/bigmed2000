...
const Bigmed2001GospelsVentura3 = () => {
...
Finally, there's what could be called indirect action -- which consists of being who you really  feel yourself to be, rather than who others would like you to be. Being it, and insisting upon it -- from this one step all others proceed.<P>

All these steps are within the power of anyone with enough basic skills to read this article.  The power is the power to begin.<P>
<CENTER>The End -- For Now!</CENTER><P></BLOCKQUOTE><P> </STRONG>
<H4>Back to: <A href="${BASE_URL}bigmed2001/gospels/ventura.html">Part 1: Primer on Revolution</A><BR>
Back to: <A href="${BASE_URL}bigmed2001/gospels/ventura2.html">Part 2: Where We've Been And Where To Go</A></H4><P>
<I>(Reprinted in the <A HREF="http://www.wwfreepress.com/">World Wide Free Press</A> from the Austin <BR>Chronicle by permission of Michael Ventura).</I><P>
...
export default Bigmed2001GospelsVentura3;
