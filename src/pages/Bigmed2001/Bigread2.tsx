...
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#corprule">W<FONT SIZE=-1>HEN CORPORATIONS RULE THE WORLD</A> <BR>- by David C. Korten</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#manic">O<FONT SIZE=-1>NE WORLD, READY OR NOT: THE MANIC LOGIC <BR>OF GLOBAL CAPITALISM</A> - by William Greider</FONT>


<LI><A href="${BASE_URL}bigmed2001/bigread1.html#publicp">E<FONT SIZE=-1>CONOMICS AND THE PUBLIC PURPOSE</A> - by John Kenneth Galbraith</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#aginfreet">T<FONT SIZE=-1>HE CASE AGAINST FREE TRADE : GATT, NAFTA AND <BR>THE GLOBALIZATION OF CORPORATE
POWER</A> - by Ralph Nader (Editor)</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#complex">T<FONT SIZE=-1>HE BIGNESS COMPLEX</A> - by W. Adams</FONT><BR>
<BR>
<FONT  SIZE=2><STRONG>INVESTIGATIVE/ACTIVIST</STRONG></FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#planet">T</FONT><FONT SIZE=-1>HE CORPORATE PLANET <BR>
- ECOLOGY AND POLITICS <BR> IN THE AGE OF GLOBALIZATION</A> - by Joshua Karliner</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#predator">C<FONT SIZE=-1>ORPORATE PREDATORS : THE HUNT FOR MEGA-PROFITS <BR>AND THE ATTACK ON DEMOCRACY</A> - by Mokhiber &amp; Weissman</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#gspin">G<FONT SIZE=-1>LOBAL SPIN : THE CORPORATE ASSAULT <BR>ON ENVIRONMENTALISM</A> - by Sharon Beder</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#greenwash">E<FONT SIZE=-1>ARTH FOR SALE - RECLAIMING ECOLOGY <BR>N THE AGE OF CORPORATE GREENWASH</A> - by Brian Tokar</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#censor99">C<FONT SIZE=-1>ENSORED 1999 : THE YEAR'S TOP 25 CENSORED STORIES</A> - by Peter Phillips (Editor)</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#censor20">20 Y<FONT SIZE=-1>EARS OF CENSORED NEWS</A> - by Carl Jensen</FONT><BR><BR>

<FONT  SIZE=2><STRONG>POPULIST/SATIRIC</STRONG></FONT><BR>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#mama">C<FONT SIZE=-1>ORPORATIONS ARE GONNA GET YOUR MAMA: 
GLOBALIZATION <BR>AND THE DOWNSIZING OF THE AMERICAN DREAM</A> - by Kevin Danaher (Editor)</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#downsize">D<FONT SIZE=-1>OWNSIZE THIS!</A> - by Michael Moore</FONT>
<LI><A href="${BASE_URL}bigmed2001/bigread1.html#yellow">T<FONT SIZE=-1>HERE'S NOTHING IN THE MIDDLE OF THE ROAD BUT <BR>YELLOW STRIPES AND DEAD ARMADILLOS</A> - by Jim Hightower 
...
export default Bigmed2001Bigread2;
