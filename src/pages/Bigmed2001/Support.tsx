...
<IMG SRC="${BASE_URL}bigmed2001/graph/advline2.gif" WIDTH=300 HEIGHT=5 vspace=5>
...
<p><font size="4" color="#000000">BIG MEDICINE<br>A 501(c)(3) Research &amp; Education Institute<br>
...
<option>Campaign Video Project Support</option> <option>Tsuyu Typhoon CD (\$20.02)</option>  
<option>Ki Video (Security Deposit: \$50)</option> <option>Gratuity for Big Med Shareware</option>
<option>Chickens, Bootlegs, Track Tips, etc.</option></select>          <BR> 
...
export default Bigmed2001Support;
