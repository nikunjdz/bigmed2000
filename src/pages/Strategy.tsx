...
<TR><TD ALIGN=MIDDLE><IMG SRC="${BASE_URL}graph/enlight.jpg" ALT="Enlighten the people..." WIDTH=470 HEIGHT=128>
</TD></TR>
</TABLE>
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=500  HEIGHT=5 VSPACE=7><BR>
...
<BR>
<IMG SRC="${BASE_URL}graph/advline2.gif" WIDTH=500 HEIGHT=5 VSPACE=7>
</CENTER>
<BLOCKQUOTE>
<STRONG>
...
We are starting this reaction as we speak with a cheap, irrevocable <A HREF="../memes/sitstrat.html">cascade of new memes and ideas</A> that expose our bodies -- sensual, corporate and planetic -- in a revelatory new light.  As these  catalytic concepts drift down through the Zeitgeist they will randomly contact the <A HREF="../sithere.html">10% of us with immunological instincts or compassionate ardor</A>, and abruptly empower them with contagious insights. It is really that simple. <P>
