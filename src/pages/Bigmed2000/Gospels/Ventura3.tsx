...
const Bigmed2000GospelsVentura3 = () => {
...
<CENTER><IMG SRC="${BASE_URL}bigmed2000/graph/advline2.gif" WIDTH=400 HEIGHT=5></CENTER><P>
<BLOCKQUOTE>
<STRONG>
...
<H4>Back to: <A href="${BASE_URL}bigmed2000/gospels/ventura.html">Part 1: Primer on Revolution</A><BR>
Back to: <A href="${BASE_URL}bigmed2000/gospels/ventura2.html">Part 2: Where We've Been And Where To Go</A></H4><P>
...
export default Bigmed2000GospelsVentura3;
