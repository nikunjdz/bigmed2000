...
<CENTER><TABLE>
<TR><TD><IMG SRC="${BASE_URL}bigmed2000/nhseal.gif" WIDTH=150 HEIGHT=150 HSPACE=15></TD><TD><CENTER><H3>STATE OF NEW HAMPSHIRE</H3>
...
<STRONG>Reference Link</STRONG><BR>(Reality Check)<BR>              <STRONG> <A HREF="http://www.state.nh.us/sos/pphome.htm">New Hampshire Presidential Primary Home Page</A> </STRONG>
<H4><A href="${BASE_URL}bigmed2000/nhpr2.html">Click here to also see Big Med's <BR>Post-Announcement Press Release</A><BR>or<BR><A href="${BASE_URL}nh/nhfly.html" target="_blank">Campaign Flier</A></H4>
...
export default Bigmed2000Nhfinal;
