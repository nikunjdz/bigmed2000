...
<FONT  COLOR=#FFFFE8><IMG SRC="${BASE_URL}bigmed2000/graph/vision5.jpg" ALT="Let us lift our vision..." WIDTH=378 HEIGHT=93 HSPACE=9 VSPACE=9 BORDER=3>
...
<FONT  COLOR=#0000dd> <A href="${BASE_URL}bigmed2000/bbonline.html" target="_parent" tabindex="."><BLINK>!</BLINK> Big Body Conference Archive <BLINK>!</BLINK></A><BR>
...
<P>
<FONT  COLOR=#0000dd> Click here to see <BR><A href="${BASE_URL}bigmed2000/nhfinal.html">Final NH Results</A><BR>or<BR><A href="${BASE_URL}bigmed2000/nhpr2.html">Big Med Press Release</A></FONT></H3>
...
<P>
Since we have no intention of building a Big Body of our own, you can't really "join" Big Medicine, but you certainly can practise it. Once you understand the principles and share a sense of common purpose, award yourself a doctorate and just go to work. Do check in here regularly, though, for campaign news, progress reports and therapeutic suggestions, and if any of this proves of value to you, please return the favor in <A href="${BASE_URL}bigmed2000/aidabet.html">kind</A> or drop some loose change in the <A href="${BASE_URL}bigmed2000/support.html">pot</A>.
...
export default Bigmed2000Nanmain2;
